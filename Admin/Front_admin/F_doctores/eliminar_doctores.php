...
<body class="bg-gray-100 min-h-screen flex flex-col">
  ...
  <div class="p-6 bg-white shadow-md">
    <form action="./eliminar_doctores.php" method="GET" class="flex gap-2">
  ...
  <!-- Tabla -->
  <?php include (__DIR__ . "/../../componentes/tablas_doctores/tabla_doctores_elim.php"); ?>
